...
<script type="text/javascript">
	...
	function send(desti,controller){
		if($("#message").val()==""){
		...
		$.ajax({
			...
			dataType:'text', 
			data:{"desti":desti,"msg":$("#message").val()},
...
<!-- 	<h1>Hello ActiveMQ</h1>
 -->	<div id="producer">
		...
		<br>
		<button onclick="send('fzc.queue','queueSend')">发送Queue消息</button>
		<button onclick="send('fzc.topic','topicSend')">发送Topic消息</button>
		<br>
		<span id="status"></span>
	</div>
</body>
