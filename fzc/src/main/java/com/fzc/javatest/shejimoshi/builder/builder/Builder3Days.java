...
public class Builder3Days extends AbsBuilder {

	public Builder3Days(String date) {
		super(date);
	...
	public void buildVacation() {
		...
		addDay();
		addTickets("fly to nanjing;");
		addTickets("bus ticket");
		addEvents("visit zhognshanling ;");
		addEvents("visit fuzimiao ;");
		addHotel("four seazon");
